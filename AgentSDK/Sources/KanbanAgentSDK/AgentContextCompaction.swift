...
public struct AgentContextCompactionPolicy: Equatable, Sendable {
    public static let dynamicTriggerRatio = 0.85

    /// Fallback trigger when the model's context window cannot be resolved.
    public var triggerTokenCount: Int = 100_000
    /// Leave enough room for tool work and the model's next response.
    public var targetTokenCount: Int = 12_000
    public var summaryTokenReserve: Int = 2_000
    public var maximumToolResultCharacters: Int = 12_000
    public var maximumSummaryInputCharacters: Int = 20_000

    public static let standard = AgentContextCompactionPolicy()

    public func adaptingTrigger(to contextWindowTokenCount: Int?) -> AgentContextCompactionPolicy {
