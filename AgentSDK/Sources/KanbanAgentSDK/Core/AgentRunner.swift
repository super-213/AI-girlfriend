...
public struct AgentInput: Sendable, Equatable {
    public let text: String
    public let imagePaths: [String]
    public let followingItems: [AgentItem]
    public let preflightToolCalls: [ToolCallItem]
...
public final class AgentRunner: AgentRunning, Sendable {
    ...
    public func run<Context: Sendable, Output: Sendable>(
        agent: AgentDefinition<Context, Output>,
        input: AgentInput,
        context: Context,
        session: any AgentSession,
    ...
    public func runNested<Context: Sendable, Output: Sendable>(
        agent: AgentDefinition<Context, Output>,
        input: AgentInput,
        context: Context,
        session: any AgentSession,
    ...
    public func resume<Context: Sendable, Output: Sendable>(
        agent: AgentDefinition<Context, Output>,
        from state: RunState,
