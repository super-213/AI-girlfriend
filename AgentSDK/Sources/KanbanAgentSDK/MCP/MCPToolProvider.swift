...
public struct MCPToolProvider<Context: Sendable>: Sendable {
    public let server: MCPServerConfiguration
    public let client: any MCPToolClient
    public let approvalPolicy: MCPApprovalPolicy
    public let filter: MCPToolFilter
    ...
    public func tools() async throws -> [AnyAgentTool<Context>] {
        try server.validate()
