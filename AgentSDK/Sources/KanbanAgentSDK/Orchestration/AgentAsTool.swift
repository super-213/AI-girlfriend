...
public struct AgentAsToolArguments: Codable, Equatable, Sendable {
    public let input: String
}

public struct AgentAsToolResult: Codable, Equatable, Sendable {
    public let agentID: String
    public let output: String
    public let usage: AgentUsage
}

public enum AgentAsTool {
    public static func make<Context: Sendable>(
        name: String,
        description: String,
    ...
    public static func make<ParentContext: Sendable, ExpertContext: Sendable>(
        name: String,
        description: String,
