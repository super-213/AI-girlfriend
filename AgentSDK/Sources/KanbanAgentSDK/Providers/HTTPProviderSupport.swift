...
public struct AgentProviderConfiguration: Sendable, Equatable {
    public let id: String
    public let endpoint: URL
    public let model: String
    public let apiKey: String?

    public init(id: String, endpoint: URL, model: String, apiKey: String? = nil) {
        self.id = id
...
public final class URLSessionAgentHTTPTransport: AgentHTTPTransport, @unchecked Sendable {
    public static let shared = URLSessionAgentHTTPTransport()
